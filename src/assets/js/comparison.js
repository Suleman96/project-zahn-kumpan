...
const PROVIDERS = [
  ...
  /* ── Praxissoftware / PVS ── */
  {
    ...
    name: 'Dampsoft',
    category: 'pvs',
    categoryLabel: 'Praxissoftware (PVS)',
    emoji: '🖥️',
    logoColor: '#1565C0',
    shortDesc: 'Marktführer für Praxisverwaltungssoftware in Deutschland — umfassend, bewährt und in über 14.000 Praxen im Einsatz.',
    monthlyPrice: 89,
    annualPrice: 960,
    trialDays: 30,
    trialLabel: '30 Tage kostenlos',
    ...
    features: {
      ...
      patientenakte: true,
      roentgenIntegration: true,
      hkpVerwaltung: true,
      kfoUnterstuetzung: true,
      datevExport: true,
      gdprCompliant: true,
    },
    priceRange: 'mittel',
    featured: true,
    pros: [
      'Marktführer — in 14.000+ deutschen Praxen im Einsatz',
      'Vollständige KFO- und GOÄ-Unterstützung',
      'Stärkste Röntgengeräte-Integration',
      '30 Tage kostenlos testen',
    ],
    cons: [
      'Keine Cloud-Version verfügbar',
      'Einrichtung erfordert technischen Support',
      'Oberfläche wirkt etwas veraltet',
    ],
    website: '#',
    tags: ['Marktführer', 'KFO', 'Röntgen'],
    tagColors: ['badge-primary', 'badge-teal', 'badge-green'],
  },
  {
    id: 'dswin',
    ...
    emoji: '💻',
    logoColor: '#2E7D32',
    shortDesc: 'Bewährte Praxissoftware von Evident — starke DATEV-Anbindung und einfache Bedienoberfläche für kleinere bis mittlere Praxen.',
    monthlyPrice: 69,
    annualPrice: 720,
    trialDays: 14,
    trialLabel: '14 Tage kostenlos',
    ...
    featured: false,
    pros: [
      'Günstigerer Einstiegspreis als Dampsoft',
      'Sehr gute DATEV-Buchhaltungsanbindung',
      'Einfach zu bedienende Oberfläche',
      '14 Tage Testphase',
    ],
    cons: [
      'Keine vollständige KFO-Unterstützung',
      'Weniger Röntgensysteme integriert',
      'Kleinere Support-Community',
    ],
    website: '#',
    tags: ['DATEV', 'Einfach', 'Testphase'],
    tagColors: ['badge-teal', 'badge-gray', 'badge-green'],
  },
  {
    id: 'cgmz1',
    name: 'CGM Z1',
    ...
    emoji: '⚙️',
    logoColor: '#6A1B9A',
    shortDesc: 'Cloud-fähige Praxissoftware von CompuGroup Medical — modern, skalierbar und für Praxisnetze geeignet.',
    monthlyPrice: 99,
    annualPrice: 1080,
    trialDays: 30,
    trialLabel: '30 Tage kostenlos',
    ...
    featured: false,
    pros: [
      'Cloud-Option — ortsunabhängiger Zugriff',
      'Ideal für Praxisnetze und mehrere Standorte',
      'Modernes Interface, regelmäßige Updates',
      'Vollständige KFO-Unterstützung',
    ],
    cons: [
      'Höchster Preis in der Kategorie',
      'Komplexere Einrichtung',
      'Cloud-Version erfordert stabile Internetverbindung',
    ],
    website: '#',
    tags: ['Cloud', 'Mehrere Standorte', 'Modern'],
    tagColors: ['badge-primary', 'badge-teal', 'badge-amber'],
  },
  ...
  /* ── Praxisfinanzierung ── */
  {
    ...
    categoryLabel: 'Praxisfinanzierung',
    emoji: '🏦',
    logoColor: '#0D47A1',
    shortDesc: 'Die Spezialbank für Heilberufe in Deutschland — bevorzugter Partner für Praxisgründungen und -übernahmen seit über 100 Jahren.',
    monthlyPrice: 0,
    annualPrice: 0,
    priceNote: 'Ab 3,9% p.a. (bonitätsabhängig)',
    trialDays: 0,
    trialLabel: 'Kostenlose Erstberatung',
    rating: 4.6,
    ratingCount: 3200,
    supportQuality: 5,
    setupEase: 3,
    features: {
      praxisGruendung: true,
      praxisUebernahme: true,
      kfwFoerderung: true,
      tilgungsfreiheit: true,
      onlineAntrag: false,
      heilberufsKonto: true,
      gdprCompliant: true,
    },
    priceRange: 'provision',
    featured: true,
    pros: [
      'Spezialbank für Ärzte und Zahnärzte',
      'Günstige Zinsen durch branchenspezifische Risikoeinschätzung',
      'Persönlicher Berater mit Zahnarzt-Branchenwissen',
      'KfW-Fördermittel-Integration',
    ],
    cons: [
      'Kein vollständig digitaler Antragsprozess',
      'Genehmigung dauert 2–4 Wochen',
      'Filialbesuch in der Regel erforderlich',
    ],
    website: '#',
    tags: ['Heilberufs-Spezialist', 'KfW', 'Bewährt'],
    tagColors: ['badge-primary', 'badge-green', 'badge-teal'],
  },
  {
    id: 'commerzbankhealth',
    name: 'Commerzbank Healthcare',
    category: 'finanzierung',
    categoryLabel: 'Praxisfinanzierung',
    emoji: '💳',
    logoColor: '#F9A825',
    shortDesc: 'Schnelle Praxisfinanzierung mit digitalem Antragsprozess und flexiblen Tilgungsmodellen für moderne Zahnarztpraxen.',
    monthlyPrice: 0,
    annualPrice: 0,
    priceNote: 'Ab 4,2% p.a. (bonitätsabhängig)',
    trialDays: 0,
    trialLabel: 'Kostenlose Erstberatung',
    rating: 4.1,
    ratingCount: 890,
    ...
    pros: [
      ...
      'Schnelle Kreditentscheidung (3–7 Werktage)',
      'Flexible Tilgungsfreiheit bis 24 Monate',
    ],
    cons: [
      'Kein spezialisiertes Heilberufs-Konto',
      'Zinsen leicht höher als apoBank',
      'Weniger Branchenerfahrung im Dentalbereich',
    ],
    website: '#',
    tags: ['Digital', 'Schnell', 'Flexibel'],
    tagColors: ['badge-teal', 'badge-amber', 'badge-gray'],
  },
];
...
function buildProviderCard(p) {
  ...
  const featureLabels = {
    ...
    patientenakte:    'Digitale Patientenakte',
    roentgenIntegration: 'Röntgen-Integration',
    hkpVerwaltung:    'HKP-Verwaltung',
    kfoUnterstuetzung:'KFO-Unterstützung',
    /* Finanzierung */
    praxisGruendung:  'Praxisgründung',
    praxisUebernahme: 'Praxisübernahme',
    kfwFoerderung:    'KfW-Fördermittel',
    tilgungsfreiheit: 'Tilgungsfreiheit',
    onlineAntrag:     'Online-Antrag',
    heilberufsKonto:  'Heilberufs-Konto',
    /* Shared */
